...
<body class="pt-5">
	...
	<div class="container p-2 pt-4">
		<div class="row">
			<div class="col-md-12">
				<form name="frm" action="./update.do" method='POST' style="width: 100%; margin: 0 auto;" enctype="multipart/form-data">
					<input type="hidden" name="categrpno" value="${catevo.categrpno }">
					<input type="hidden" id="cateno" name="cateno" value="${catevo.cateno}">
					<input type="hidden" name="contentno" value="${contentvo.contentno }">
					<input type="hidden" name="adminno" value="1">
					<div class="row mb-2 pb-2 border-bottom">
						<div class="col-md-12">
							<input class="input_css" type="text" name="title" placeholder="제목을 입력하세요" style="font-size: 30px;" value="${contentvo.title }">
						</div>
					</div>
					<div class="row mb-2 pb-2 border-bottom"">
						<div class="col-md-12">
							<textarea rows="12" name="content" class="form-control" style="height: 600px; border: none;">${contentvo.content }</textarea>
						</div>
					</div>
					<div class="row mb-2 pb-2 border-bottom"">
						<div class="col-md-12">
							<input class="input_css" type="text" name="word" placeholder="태그 입력"  value="${contentvo.word }">
						</div>
					</div>
					<div class="row mb-2 pb-2 border-bottom"">
						<div class="col-md-12">
							<input class="input_css" type="text" name="passwd" placeholder="password">
						</div>
					</div>
					<div class="row mb-2 pb-2 border-bottom"">
						<div class="col-md-12">
